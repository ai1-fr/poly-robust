function [Ctr, cntrl]=GIget(A, s, cntrl)
%GIGET: contrast G optimization in the case of identity contrast H
...
%Call:  [Ctr, cntrl]=GIget(A, s, cntrl)
% 
...
H=eye(n);
% evaluate esimation risks for "identity" H contrast
[tcpu1,Opti] = hevalp(H, A, s, cntrl);
optv.Opti=Opti;
optv.Opt1=2*s*Opti;
